      ...
      <nav className="flex-1 space-y-1.5 px-2.5 py-4">
        {navItems.map(({ to, icon: Icon, label }) => (
          ...
          >
            {({ isActive }) => (
              <>
                <div className="relative flex items-center justify-center rounded-xl p-1.5" style={{ background: isActive ? 'rgba(255,255,255,0.12)' : 'rgba(255,255,255,0.06)' }}>
                  <Icon
        ...
        {billingAccess?.showBanner && (billingAccess?.actionUrl || onBillingAction) ? (
          ...
          >
            <div className="relative flex items-center justify-center rounded-xl p-1.5" style={{ background: 'rgba(255,255,255,0.12)' }}>
