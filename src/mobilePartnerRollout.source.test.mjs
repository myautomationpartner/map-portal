...
test('phone portal uses warm cream/ink tokens and full Final review captions', () => {
  ...
  assert.doesNotMatch(appCssSource, /\.mobile-partner-generated-caption p \{[\s\S]{0,220}-webkit-line-clamp: 4/)
  assert.doesNotMatch(appCssSource, /\.mobile-partner-post-caption p \{[\s\S]{0,220}-webkit-line-clamp: 3/)
  assert.match(appCssSource, /\.mobile-partner-generated-platforms \{[\s\S]{0,120}flex-wrap: wrap/)
  assert.match(appCssSource, /\.mobile-partner-generated-actions \.mobile-partner-primary \{[\s\S]{0,220}background: var\(--pulse-ink\)/)
  assert.match(appCssSource, /\.mobile-publisher-conversation \.mobile-partner-generated-actions \{[\s\S]{0,180}position: sticky/)
  assert.match(createSource, /Nothing posts until you approve it/)
