export const plannerContract = {
  ...
  clients: {
    dancescapes: {
      ...
      content_mix_targets: {
        promotional_offer: 0.25,
        class_spotlight: 0.2,
        community_story: 0.2,
        testimonial_social_proof: 0.15,
      ...
      seasonal_modifiers: [
        ...
        },
        {
          ...
          cadence_adjustment: { target_posts_per_week_delta: 1, max_posts_per_week_override: 4 },
          post_type_priority_boost: ['event_or_performance', 'community_story', 'testimonial_social_proof'],
        },
        {
          modifier_slug: 'holiday_break_light_schedule',
          active_months: [11, 12],
          cadence_adjustment: { target_posts_per_week_delta: -1, min_posts_per_week_override: 1 },
          post_type_priority_boost: ['community_story', 'seasonal_campaign'],
        },
      ],
    },
  },
